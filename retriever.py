...
prompt = ChatPromptTemplate.from_template(
    ...
    Question: {input}
    Rules:
    - If the answer is in the context, copy it exactly without adding extra details.
    """
    )
...
ret_chin = create_retrieval_chain(retriever,doc_chain)

# streamlit code

st.title("GreenAsha Chatbot Testing")
